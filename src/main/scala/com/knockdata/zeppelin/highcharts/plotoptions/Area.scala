...
private[highcharts] class Area extends BasePlotOptions with PublicApply {
  def fieldName = "area"
  ...
  /**
    * Not in Highcharts API, check http://www.highcharts.com/demo/line-time-series
    */
  def fillColorLinearGradient(values: (String, Any)*): this.type = {
    append("fillColor", "linearGradient", values.toMap)
  }

  /**
    * Not in Highcharts API, check http://www.highcharts.com/demo/line-time-series
    */
  def fillColorStops(values: (Int, Any)*): this.type = {
    append("fillColor", "stops",
      values.map {
        case (k, v: String) => k -> placeholdCode(v)
        case (k, v: Code) => k -> placeholdCode(v)
      }.toList)
  }
  ...
  // NOT in API DOC
  def pline(value: Any): this.type = {
    append("pline", value)
  }

  // NOT in API DOC
  def plinerange(value: Any): this.type = {
    append("plinerange", value)
  }
