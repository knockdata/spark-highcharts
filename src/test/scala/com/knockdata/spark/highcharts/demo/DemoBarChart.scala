...
import com.knockdata.spark.highcharts.model.{Chart, XAxis}
...
class DemoBarChart {
  ...
  def demoBarHistogram(): Unit = {
    ...
    new PrintWriter("target/demoBarHistogram.json") { write(chart.replaced); close }
  }
//
//  // ## Stacked Column
//  //
